...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/categories/npu-laptop`, lastModified: now,                    changeFrequency: 'weekly',  priority: 0.8 },
    { url: `${BASE}/categories/dock`,       lastModified: now,                    changeFrequency: 'weekly',  priority: 0.75 },
    { url: `${BASE}/categories/accessory`,  lastModified: now,                    changeFrequency: 'weekly',  priority: 0.7 },
    { url: `${BASE}/categories/nas`,        lastModified: now,                    changeFrequency: 'weekly',  priority: 0.7 },
