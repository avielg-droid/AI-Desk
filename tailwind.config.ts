...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'forge-sm': '0 0 12px rgba(8,145,178,0.15), 0 0 30px rgba(6,182,212,0.06)',
        'forge-md': '0 0 20px rgba(8,145,178,0.20), 0 0 50px rgba(6,182,212,0.10)',
        'forge-lg': '0 0 40px rgba(8,145,178,0.25), 0 0 80px rgba(6,182,212,0.12)',
        ...
        'aurora-sm': '0 0 12px rgba(8,145,178,0.15), 0 0 30px rgba(6,182,212,0.06)',
        'aurora-md': '0 0 20px rgba(8,145,178,0.20), 0 0 50px rgba(6,182,212,0.10)',
        'aurora-lg': '0 0 40px rgba(8,145,178,0.25), 0 0 80px rgba(6,182,212,0.12)',
      },
    },
  },
  plugins: [],
